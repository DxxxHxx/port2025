...
React Query의 Optimistic Update를 적용하여 <span style="color:blue">UI 업데이트 속도를 2000ms에서 0.5ms로 줄여 UX를 개선</span>하였습니다.
iOS Safari, Chrome에서의 크로스브라우징 이슈를 해결하여 다양한 기기에서 일관된 UX를 제공하였습니다.
